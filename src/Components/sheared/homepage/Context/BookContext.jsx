...
import { addReadlistToLocalDB, addWishlistToLocalDB, getAddToReadlistLocalDB, getAddToWishlistLocalDB } from "../../../utils/LoacalDB";

export const BookContext = createContext();

const BookProvider = ({ children }) => {
  const [booksRead, setBooksRead] = useState(() => getAddToReadlistLocalDB());
  const [wishedBook, setWishedBook] = useState(() => getAddToWishlistLocalDB());
